<form id="form_filter" action="{{route('khachhang.index')}}" method="get">
        ...
        <div class="uk-flex uk-flex-middle uk-flex-space-between">
            ...
            <div class="action">
                <div class="uk-flex uk-flex-middle">
                    ...
                    <a href="{{route('khachhang.create')}}"><button type="button" class="btn btn-primary"><i
                                class="fa fa-plus mr5"></i>Thêm mới khách hàng</button></a>
                </div>
            </div>
        </div>
    </div>
